import { ExcelBuddyComponent } from './components/Excel-buddy--external/Excel-buddy--external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, ExcelBuddyComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, ExcelBuddyComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
